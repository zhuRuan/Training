...
# 计算方法设置
calc_method_tuple = ('std','std_ratio','mean_diff','mean')  # 总共有('std','std_ratio','mean_diff','mean')四种可以选择
...
# 可选 ： 'circ_mv', 'dv_ratio', 'dv_ttm', 'float_share', 'free_share', 'pe', 'pe_ttm', 'ps', 'ps_ttm', 'total_mv',
#     'total_share', 'turnover_rate', 'turnover_rate_f', 'volume_ratio'
